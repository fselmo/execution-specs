...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.amsterdam.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.amsterdam.fork.EMPTY_OMMER_HASH
    """
    ...
    [cbalh]: ref:ethereum.forks.amsterdam.block_access_lists.rlp_utils.compute_block_access_list_hash  # noqa: E501
    """
...
class Block:
    ...
    [withdrawals]: ref:ethereum.forks.amsterdam.blocks.Withdrawal
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.amsterdam.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.amsterdam.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.amsterdam.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.amsterdam.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.amsterdam.vm.instructions.log.log4
    """
