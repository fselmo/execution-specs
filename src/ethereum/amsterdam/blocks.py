...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.amsterdam.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.amsterdam.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.amsterdam.state.state_root
    [Trie]: ref:ethereum.amsterdam.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.amsterdam.trie.root
    [Trie]: ref:ethereum.amsterdam.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.amsterdam.bloom.logs_bloom
    """
    ...
    [crh]: ref:ethereum.amsterdam.requests.compute_requests_hash
...
class Block:
    ...
    [`header`]: ref:ethereum.amsterdam.blocks.Header
    [withdrawals]: ref:ethereum.amsterdam.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.amsterdam.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.amsterdam.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.amsterdam.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.amsterdam.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.amsterdam.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.amsterdam.vm.instructions.log.log4
    """
